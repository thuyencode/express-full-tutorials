...
import tutorial_17_routes from './tutorial-17.ts'
...
// tutorials_routes.use('/16', tutorial_16_routes)
tutorials_routes.use('/17', tutorial_17_routes)
// tutorials_routes.use('/19', tutorial_19_routes)
